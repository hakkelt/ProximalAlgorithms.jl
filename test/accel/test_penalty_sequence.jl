...
import ProximalAlgorithms: FixedPenalty, ResidualBalancingPenalty, 
                            SpectralRadiusBoundPenalty, SpectralRadiusApproximationPenalty,
                          reinstantiate_penalty_sequence,
                          get_next_rho!, ADMMState, ADMMIteration, CGState
